...
var IgnoreMemberComponent = function (_React$Component) {
  _inherits(IgnoreMemberComponent, _React$Component);

  function IgnoreMemberComponent() {
    _classCallCheck(this, IgnoreMemberComponent);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(IgnoreMemberComponent).apply(this, arguments));
  }

  _createClass(IgnoreMemberComponent, [{
    key: 'render',
  ...
  return IgnoreMemberComponent;
}(React.Component);

exports.default = IgnoreMemberComponent;

},{"react":167,"react-dom":29}],169:[function(require,module,exports){
'use strict';
...
var IgnoreMemberRegistererComponent = function (_React$Component) {
  _inherits(IgnoreMemberRegistererComponent, _React$Component);

  function IgnoreMemberRegistererComponent() {
    _classCallCheck(this, IgnoreMemberRegistererComponent);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(IgnoreMemberRegistererComponent).apply(this, arguments));
  }

  _createClass(IgnoreMemberRegistererComponent, [{
  ...
  return IgnoreMemberRegistererComponent;
}(React.Component);

exports.default = IgnoreMemberRegistererComponent;

},{"react":167,"react-dom":29}],170:[function(require,module,exports){
'use strict';
...
var _ignoreMemberComponent = require('./ignore-member-component');

var _ignoreMemberComponent2 = _interopRequireDefault(_ignoreMemberComponent);
...
var IgnoreSetComponent = function (_React$Component) {
  _inherits(IgnoreSetComponent, _React$Component);

  function IgnoreSetComponent() {
    _classCallCheck(this, IgnoreSetComponent);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(IgnoreSetComponent).apply(this, arguments));
  }

  _createClass(IgnoreSetComponent, [{
    key: 'render',
    value: function render() {
      ...
      return React.createElement(
        'div',
        { className: 'ignore-set' },
        [].concat(_toConsumableArray(this.props.ignoreSet)).map(function (name) {
          return React.createElement(_ignoreMemberComponent2.default, { key: name, name: name, remove: remove });
        })
      );
    }
  }]);

  return IgnoreSetComponent;
}(React.Component);

exports.default = IgnoreSetComponent;

},{"./ignore-member-component":168,"react":167,"react-dom":29}],171:[function(require,module,exports){
'use strict';
...
var _ignoreMemberRegistererComponent = require('../components/ignore-member-registerer-component');

var _ignoreMemberRegistererComponent2 = _interopRequireDefault(_ignoreMemberRegistererComponent);

var _ignoreSetComponent = require('../components/ignore-set-component');

var _ignoreSetComponent2 = _interopRequireDefault(_ignoreSetComponent);
...
var OptionEditor = function (_React$Component) {
  _inherits(OptionEditor, _React$Component);

  function OptionEditor() {
    _classCallCheck(this, OptionEditor);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(OptionEditor).apply(this, arguments));
  }

  _createClass(OptionEditor, [{
    key: 'componentWillMount',
    value: function componentWillMount() {
    ...
    value: function register(name) {
      ...
      var ignoreSet = this.state.ignoreSet;

      ignoreSet.add('@' + name.replace(/@/g, '').replace(/\s/g, ''));
      _store.store.saveIgnoreSet(ignoreSet, function () {
    ...
    value: function reload() {
      ...
      _store.store.loadIgnoreSet(function (v) {
        return _this4.setState({ ignoreSet: v });
      });
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      var remove = function remove(name) {
        return _this5.remove(name);
      };
      var register = function register() {
        return _this5.register.apply(_this5, arguments);
      };

      return React.createElement(
        'div',
        null,
        React.createElement(_ignoreMemberRegistererComponent2.default, { register: register }),
        React.createElement(_ignoreSetComponent2.default, { ignoreSet: ignoreSet, remove: remove })
      );
    }
  }]);
...
},{"../../util/store":173,"../components/ignore-member-registerer-component":169,"../components/ignore-set-component":170,"react":167,"react-dom":29}],172:[function(require,module,exports){
'use strict';
...
var _optionEditor = require('./contexts/option-editor');

var _optionEditor2 = _interopRequireDefault(_optionEditor);
...
var Option = function () {
  ...
  _createClass(Option, null, [{
    key: 'run',
    value: function run(dom) {
      ReactDOM.render(React.createElement(_optionEditor2.default, null), dom);
    }
  }]);
...
},{"./contexts/option-editor":171,"react":167,"react-dom":29}],173:[function(require,module,exports){
'use strict';
